...
export const friendlySourceError = (error: unknown) => {
  ...
  if (/No (image files|photos|photos or videos) were found/i.test(message)) return 'No supported image files were found at that link. Add JPG, WebP, AVIF, HEIC, or HEIF images and try again.'
